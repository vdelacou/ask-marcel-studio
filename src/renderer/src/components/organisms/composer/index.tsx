  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-3xl flex-col gap-y-2">
        ...
        <div className="flex flex-col gap-y-1.5 rounded-2xl border border-border-subtle bg-surface px-3 py-2 shadow-sm transition focus-within:border-ink-muted">
        ...
        {/* Attaching on the left, the model on the right: what you add to the message,
            and what will answer it. */}
        <div className="flex items-center justify-between px-1">
          <button
            ...
            className="rounded-lg p-1 text-ink-muted transition hover:text-ink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent"
          >
